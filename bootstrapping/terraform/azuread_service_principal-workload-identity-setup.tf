...
resource "azuread_application" "github-workload-identity" {
    display_name = "${var.prefix}-workload-identity-${var.entity_type}-${var.entity_name}"
...
resource "azuread_application_federated_identity_credential" "github-workload-identity" {
    ...
    display_name   = "${var.prefix}-gh-azure-workload-identity-${var.entity_type}-${var.entity_name}"
